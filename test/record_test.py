...
#     recorder = you_live.Recorder.createRecorder('kuaishou', 'GS6666666', check_flv = True, cookies = None)
    recorder = you_live.Recorder.createRecorder('acfun', '550051', check_flv = True, cookies = None)
